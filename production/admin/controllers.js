...
exports.getAdmins = exports.getWithdrawals = exports.getExchanges = exports.updateExchange = exports.loginAdmin = exports.addAdmin = exports.deleteAdmin = exports.changePassword = exports.getPayments = exports.getInvestments = exports.getUsers = void 0;
...
function changePassword(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const username = (_a = req.session.admin) === null || _a === void 0 ? void 0 : _a.username;
        ...
        if (response1.success) {
            ...
            const matchPassword = bcrypt_1.default.compareSync(old_password, admin.password);
            if (matchPassword) {
...
function deleteAdmin(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const isSuperUser = (_a = req.session.admin) === null || _a === void 0 ? void 0 : _a.isSuperUser;
        if (isSuperUser) {
            const queryResponse = yield query.deleteRecord({ admin_id });
...
function addAdmin(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isSuperUser) {
            try {
                const env_password = username.length > 8 ?
                    username :
                    `${username}${getDigit((8 - username.length))}`;
                const salt = yield bcrypt_1.default.genSalt();
                const hashed = yield bcrypt_1.default.hash(env_password, salt);
                const checkUserReq = yield query.find({ username });
                if (!checkUserReq.success) {
                    const response = yield query.createRecord({
                        username,
                        password: hashed,
