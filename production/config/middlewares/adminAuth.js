...
var admins_1 = require("../models/sql/admins");
...
function addSuperUser() {
    return __awaiter(this, void 0, void 0, function () {
        var query, res, admin, salt, env_password, hashed, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    if ((res === null || res === void 0 ? void 0 : res.length) !== 0) {
                        return [2 /*return*/, "Superuser exists"];
                    }
                    admin = {
