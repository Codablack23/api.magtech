...
function findUser(route) {
    ...
    if (route === "login") {
        return function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var phone, query, userExist, error_1;
    ...
    return function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
        var _a, phone_no, username, query, userExist, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.body, phone_no = _a.phone, username = _a.username;
                    console.log(req.body);
                    query = new Queries_1.SQLQuery(user_1.User);
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, query.find({ $or: [{ phone_no: phone_no }, { username: username }] })];
                case 2:
                    userExist = _b.sent();
                    if (!userExist.res) {
                        return [2 /*return*/, next()];
